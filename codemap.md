...
| `docs/` | Project documentation root. Contains `adr/` (architecture decision records), `agents/` (agent workflow docs), `plans/` (feature plans), and `project-report/` (report drafts). Flat documentation files were removed — `AGENTS.md` and source code are the canonical references. | [View Map](docs/codemap.md) |
